...
class ProductReportForm(forms.ModelForm):
    class Meta:
        model = ProductReport
        fields = {
            'author', 'For_Date', 'Machinery', 'Crasher_Elec_Consumption', 'Rockstone_Shortage', 'No_Needed',
            'Electrical_Fault',
            'Mechanical_Fault', 'Operator_Fault', 'Total_Fault',
            'Kenaf_Rawmat_Consumption_1', 'Kenaf_Rawmat_Consumption_2', 'Kenaf_Stucco_Prod_1', 'Kenaf_Stucco_Prod_2',
            'Ordinary_RawMat_Consumption_1', 'Ordinary_RawMat_Consumption_2', 'Ordinary_Stucco_Prod_1',
            'Ordinary_Stucco_Prod_2',
            'Block_RawMat_Consumption_1', 'Block_RawMat_Consumption_2', 'Block_Stucco_Prod_1', 'Block_Stucco_Prod_2',
            'Nealit_RawMat_Consumption',
            'Nealit_Sugar_Consumption', 'Nealit_Prod', 'Total_Consumption_1', 'Total_Consumption_2', 'Total_Prod_1',
            'Total_Prod_2',
            ...
            'Gas_Consumption_PM_1', 'Gas_Consumption_PM_2', 'Gasoil_Consumption_AM_1', 'Gasoil_Consumption_AM_2',
            'Gasoil_Consumption_PM_1',
            'Gasoil_Consumption_PM_2', 'Gas_Temperature_1', 'Gas_Temperature_2', 'Gas_Presure_1', 'Gas_Presure_2'
        }
        widgets = {
            'For_Date': widgets.DateInput(attrs={'type': 'date'}),
            'Machinery': widgets.NumberInput(),
            'Crasher_Elec_Consumption': widgets.NumberInput(),
            'Rockstone_Shortage': widgets.NumberInput(),
            ...
            'Total_Fault': widgets.NumberInput(attrs={'disabled': True}),
            'Kenaf_Rawmat_Consumption_1': widgets.NumberInput(),
            'Kenaf_Rawmat_Consumption_2': widgets.NumberInput(),
            ...
            'Block_Stucco_Prod_1': widgets.NumberInput(),
            'Block_Stucco_Prod_2': widgets.NumberInput(),
            'Nealit_RawMat_Consumption': widgets.NumberInput(),
            'Nealit_Sugar_Consumption': widgets.NumberInput(),
            'Nealit_Prod': widgets.NumberInput(),
            'Total_Consumption_1': widgets.NumberInput(attrs={'disabled': True}),
            'Total_Consumption_2': widgets.NumberInput(attrs={'disabled': True}),
            'Total_Prod_1': widgets.NumberInput(attrs={'disabled': True}),
            'Total_Prod_2': widgets.NumberInput(attrs={'disabled': True}),
            ...
            'Total_Stoppage_1': widgets.NumberInput(attrs={'disabled': True}),
            'Total_Stoppage_2': widgets.NumberInput(attrs={'disabled': True}),
            'Total_Stoppage_Nealit': widgets.NumberInput(attrs={'disabled': True}),
