...
class ProductReport(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.Total_Consumption_1 = self.Block_RawMat_Consumption_1 + self.Nealit_RawMat_Consumption + self.Kenaf_Rawmat_Consumption_1 + self.Ordinary_RawMat_Consumption_1
        self.Total_Consumption_2 = self.Block_RawMat_Consumption_2 + self.Nealit_RawMat_Consumption + self.Kenaf_Rawmat_Consumption_2 + self.Ordinary_RawMat_Consumption_2
