...
class ProductReport(models.Model):
    ...
    Total_Fault = models.IntegerField(editable=True)
    ...
    Total_Stoppage_1 = models.IntegerField()
    Total_Stoppage_2 = models.IntegerField()
    Total_Stoppage_Nealit = models.IntegerField()
    # silo inventories
